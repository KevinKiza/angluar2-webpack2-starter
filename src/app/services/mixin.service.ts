...
import { DATE_FORMAT, DAY_IN_MILLISECONDS } from "../components/common/constants";
...
export class MixinService {
    ...
    getCurrentDate(addDays?: number): Date {
        ...
        if (addDays !== null && addDays !== undefined) {
            ...
            currentDate = new Date(time + (addDays * DAY_IN_MILLISECONDS));
        }
